#pragma once
// AggCoreNodes — pure logic implementations of the AGG vector node types.
...
// ============================================================
class AggLineCoreNode : public CoreNode {
public:
  AggLineCoreNode();
...
// ============================================================
class AggCircleCoreNode : public CoreNode {
public:
  AggCircleCoreNode();
...
// ============================================================
class AggRectCoreNode : public CoreNode {
public:
  AggRectCoreNode();
...
// ============================================================
class AggPolygonCoreNode : public CoreNode {
public:
  AggPolygonCoreNode();
...
// ============================================================
class AggTextCoreNode : public CoreNode {
public:
  AggTextCoreNode();
...
// ============================================================
class AggArcCoreNode : public CoreNode {
public:
  AggArcCoreNode();
...
// ============================================================
class AggBezierCoreNode : public CoreNode {
public:
  AggBezierCoreNode();
...
// ============================================================
class AggDashLineCoreNode : public CoreNode {
public:
  AggDashLineCoreNode();
...
// ============================================================
class AggGradientCoreNode : public CoreNode {
public:
  AggGradientCoreNode();
